<template>
  <div class="params_container">
    ...
    <el-card>
      <el-alert title="注意:第三级分类才可设置参数" type="warning" show-icon></el-alert>
      ...
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="动态参数" name="many">
          <el-button type="success" :disabled="disabled" @click="showAdd()">添加动态参数</el-button>
        ...
        <el-tab-pane label="静态参数" name="only">
          <el-button type="success" :disabled="disabled" @click="showAdd()">添加静态参数</el-button>
